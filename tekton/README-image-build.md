...
kubectl apply -f https://raw.githubusercontent.com/ot4i/ace-demo-pipeline/demo-pipeline-21-06/tekton/ace-minimal-image-pipeline-run.yaml
...
kubectl apply -f https://raw.githubusercontent.com/ot4i/ace-demo-pipeline/demo-pipeline-21-06/tekton/ace-minimal-build-image-pipeline-run.yaml
...
```
kubectl apply -f https://raw.githubusercontent.com/ot4i/ace-demo-pipeline/demo-pipeline-21-06/tekton/os/ace-minimal-image-pipeline-run-crc.yaml
kubectl apply -f https://raw.githubusercontent.com/ot4i/ace-demo-pipeline/demo-pipeline-21-06/tekton/os/ace-minimal-build-image-pipeline-run-crc.yaml
```
